...
<html lang="en">
    ...
    <body>
        <main>
            ...
            <div class = "row">
                <div class = "container">
                    <form action="Cbooking.php" method="POST" id="register_form">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active_tab1" style="border:1px solid #ccc" id="list_b_details">Booking Details</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link inactive_tab1" id="list_g_info" style="border:1px solid #ccc">Guest Information</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link inactive_tab1" id="list_payment" style="border:1px solid #ccc">Payment</a>
                            </li>
                        </ul>
                        <div class="tab-content" style="margin-top:16px;">
                            <div class="tab-pane active" id="b_details">
                                <div class="panel panel-default">
                                    <div class="panel-heading">Booking Details</div>
                                    <div class="panel-body">
                                        <input name='comment' type="text" placeholder="Special Requests"/>
                                        <br />
                                        <div align="center">
                                            <button type="button" name="btn_b_details" id="btn_b_details" class="btn btn-info btn-lg">Next</button>
                                        </div>
                                        <br />
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="g_info">
                                <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <br />
                                            <div align="center">
                                                <button type="button" name="previous_btn_g_info" id="previous_btn_g_info" class="btn btn-default btn-lg">Previous</button>
